...
using MangaHunter.Contracts.Mangadex.Models.Relationships;
...
/// </summary>
public class MangaDto : MangaDexModel<MangaDto.MangaAttributesModel>, IRelationshipModel
{
	/// <summary>
...
/// </summary>
public class MangaList : MangaDexCollection<MangaDto> { }