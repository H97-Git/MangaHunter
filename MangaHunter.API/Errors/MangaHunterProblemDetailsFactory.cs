...
namespace MangaHunter.API.Errors;

public class MangaHunterProblemDetailsFactory : ProblemDetailsFactory
{
    private readonly ApiBehaviorOptions _options;

    public MangaHunterProblemDetailsFactory(IOptions<ApiBehaviorOptions> options)
    {
    ...
    private void ApplyProblemDetailsDefaults(HttpContext httpContext, ProblemDetails problemDetails, int statusCode)
    {
        ...
        {
            problemDetails.Extensions.Add("errorCodes", errors.ConvertAll(x => x.Code));
        }
    }
}